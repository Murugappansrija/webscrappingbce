...
const scrapeAmazon = async () => {
  try {
    const url =
      "https://www.amazon.in/s?i=electronics&rh=n%3A65320318031&fs=true&page=2&qid=1686295107&ref=sr_pg_2";
    ...
    $("div.a-section.a-spacing-base").each((idx, ele) => {
      ...
      const priceElement = $(ele).find(
        'span.a-price.a-text-price[data-a-size="b"][data-a-strike="true"][data-a-color="secondary"]'
      );
